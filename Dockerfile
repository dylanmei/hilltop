...
# AH3 DEV-KIT
ENV DEVKIT_LIB /usr/lib/anthill3-dev-kit
RUN curl -sL "https://s3-us-west-2.amazonaws.com/dylanmei/hilltop/anthill3-dev-kit.zip" \
      -o /tmp/anthill3-dev-kit.zip \
    && unzip /tmp/anthill3-dev-kit.zip -d /usr/lib/ \
    && rm /tmp/*.zip
